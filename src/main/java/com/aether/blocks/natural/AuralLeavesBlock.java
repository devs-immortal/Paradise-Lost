...
public class AuralLeavesBlock extends AetherLeavesBlock implements DynamicBlockColorProvider {
    ...
    public static int getAuralColor(BlockPos pos, Vec3i[] gradientCols){
        float clumpSize = 12;
        PerlinNoiseSampler perlin = new PerlinNoiseSampler(new Random(1738));
        // sample perlin noise
        ...
        // rinse, repeat.
        perlin = new PerlinNoiseSampler(new Random(1337));
        ...
        perlin = new PerlinNoiseSampler(new Random(9980));
