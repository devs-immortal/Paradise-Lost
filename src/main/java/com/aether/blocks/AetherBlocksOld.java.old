...
public class AetherBlocksOld {
    ...
    public static final Block BLUE_PORTAL = register("blue_portal", new AetherPortalBlock(Settings.of(Material.PORTAL, MapColor.BLUE).noCollision().ticksRandomly().nonOpaque().blockVision(AetherBlocksOld::never).strength(-1.0f).sounds(BlockSoundGroup.GLASS).luminance((state) -> 11)));
    ...
    public static final Block AEROGEL = register("aerogel", new Block(Settings.of(Material.SOIL).strength(1.0f, 2000.0f).sounds(BlockSoundGroup.GLASS).solidBlock(AetherBlocksOld::never).nonOpaque()), buildingBlock());
    public static final Block AETHER_FARMLAND = register("aether_farmland", new FarmlandBlock(Settings.of(Material.SOIL).ticksRandomly().strength(0.6f).sounds(BlockSoundGroup.GRAVEL).blockVision(AetherBlocksOld::always).suffocates(AetherBlocksOld::always)), buildingBlock());
    ...
    public static final Block BLUEBERRY_BUSH = register("blueberry_bush", new BlueberryBushBlock(Settings.of(Material.PLANT).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(AetherBlocksOld::canSpawnOnLeaves).suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never).noCollision()));
    ...
    public static final Block QUICKSOIL_GLASS = register("quicksoil_glass", new GlassBlock(Settings.of(Material.GLASS).luminance(state -> 14).strength(0.2f, -1.0f).slipperiness(1.0F).velocityMultiplier(1.102F).sounds(BlockSoundGroup.GLASS).nonOpaque().solidBlock(AetherBlocksOld::never)), buildingBlock());
    public static final Block QUICKSOIL_GLASS_PANE = register("quicksoil_glass_pane", new PaneBlock(Settings.of(Material.GLASS).luminance(state -> 14).strength(0.2F, -1.0F).slipperiness(1.0F).velocityMultiplier(1.102F).sounds(BlockSoundGroup.GLASS).nonOpaque().solidBlock(AetherBlocksOld::never)), buildingBlock());
    ...
    public static final Block STRIPPED_WISTERIA_WOOD = register("stripped_wisteria_wood", createLogBlock(MapColor.RED, MapColor.RED), buildingBlock());
        ...
        private static final Settings ROSE_WISTERIA = Settings.of(Material.LEAVES, MapColor.PINK).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
    ...
    public static final Block ROSE_WISTERIA_HANGER = register("rose_wisteria_hanger", new AetherHangerBlock(createWisteriaHangerBlock(BlockSoundGroup.GRASS)), buildingBlock());
        ...
        private static final Settings FROST_WISTERIA = Settings.of(Material.LEAVES, MapColor.LIGHT_BLUE).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
    ...
    public static final Block FROST_WISTERIA_HANGER = register("frost_wisteria_hanger", new AetherHangerBlock(createWisteriaHangerBlock(BlockSoundGroup.GRASS)), buildingBlock());
        ...
        private static final Settings LAVENDER_WISTERIA = Settings.of(Material.LEAVES, MapColor.MAGENTA).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
    ...
    private static Settings createLeafPileBlock(BlockSoundGroup sounds) {
        return Settings.of(Material.REPLACEABLE_PLANT).strength(0.2f).sounds(sounds).nonOpaque().suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
    }

    private static Settings createWisteriaHangerBlock(BlockSoundGroup sounds) {
        return Settings.of(Material.DECORATION).strength(0.2f).noCollision().breakInstantly().sounds(sounds).nonOpaque().suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
    }
    ...
    private static Settings createLeavesProperties(@Nullable Integer luminance, @Nullable BlockSoundGroup sounds) {
        ...
        Settings properties = Settings.of(Material.LEAVES).strength(0.2f).ticksRandomly().sounds(sounds).nonOpaque().allowsSpawning(AetherBlocksOld::ocelotOrParrot).suffocates(AetherBlocksOld::never).blockVision(AetherBlocksOld::never);
        if (luminance != null) {
