...
//    public static final Block WHITE_DYED_AERCLOUD;
    ...
    static {
        ...
        final AbstractBlock.Settings GRASS = AbstractBlock.Settings.of(Material.REPLACEABLE_PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS);
        ...
        BLUE_PORTAL = register("blue_portal", new AetherPortalBlock(AbstractBlock.Settings.of(Material.PORTAL, MapColor.BLUE).noCollision().ticksRandomly().nonOpaque().blockVision(AetherBlocks::never).strength(-1.0f).sounds(BlockSoundGroup.GLASS).luminance((state) -> 11)));
        ...
        AETHER_FARMLAND = register("aether_farmland", new AetherFarmlandBlock(AbstractBlock.Settings.of(Material.SOIL).ticksRandomly().strength(0.6f).sounds(BlockSoundGroup.GRAVEL).blockVision(AetherBlocks::always).suffocates(AetherBlocks::always)), buildingBlock());
        ...
        final AbstractBlock.Settings ANGELIC_STONES = AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).resistance(1.0f).sounds(BlockSoundGroup.STONE);
        ...
        ANGELIC_SLAB = register("angelic_slab", new SlabBlock(AbstractBlock.Settings.copy(ANGELIC_STONE)), buildingBlock());
...
//        ANGELIC_STONE_TRAP = register("angelic_stone_trap", new Block(BlockBehaviour.Properties.of(Material.STONE).hardness(-1.0f).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        ...
        BLUEBERRY_BUSH = register("blueberry_bush", new BlueberryBushBlock(AbstractBlock.Settings.of(Material.PLANT).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(AetherBlocks::canSpawnOnLeaves).suffocates(AetherBlocks::never).blockVision(AetherBlocks::never).noCollision()));
...
//        BROWN_DYED_AERCLOUD = register("brown_dyed_aercloud", null);
        CARVED_STONE = register("carved_stone", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).resistance(1.0f).sounds(BlockSoundGroup.STONE)), buildingBlock());
        CARVED_STONE_TRAP = register("carved_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        CARVED_SLAB = register("carved_slab", new SlabBlock(AbstractBlock.Settings.copy(CARVED_STONE)), buildingBlock());
        CARVED_STAIRS = register("carved_stairs", new StairsBlock(CARVED_STONE.getDefaultState(), AbstractBlock.Settings.copy(CARVED_STONE)), buildingBlock());
        CARVED_WALL = register("carved_wall", new WallBlock(AbstractBlock.Settings.copy(CARVED_STONE)), buildingBlock());
...
//        FREEZER = register("freezer", null);
        ...
        GRAVITITE_ORE = register("gravitite_ore", new FloatingBlock(false, AbstractBlock.Settings.of(Material.STONE).strength(5.0F).sounds(BlockSoundGroup.STONE), UniformIntProvider.create(0, 2)), buildingBlock());
        GRAVITITE_LEVITATOR = register("gravitite_levitator", new FloatingBlock(true, AbstractBlock.Settings.of(Material.WOOD).strength(3.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), buildingBlock());
//        GREEN_DYED_AERCLOUD = register("green_dyed_aercloud", null);
//        GREY_DYED_AERCLOUD = register("grey_dyed_aercloud", null);

        final AbstractBlock.Settings HELLFIRE_STONES = AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).resistance(1.0f).sounds(BlockSoundGroup.STONE);
        ...
        HELLFIRE_STONE_TRAP = register("hellfire_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        HELLFIRE_WALL = register("hellfire_wall", new WallBlock(AbstractBlock.Settings.copy(HELLFIRE_STONE)), buildingBlock());
        HELLFIRE_SLAB = register("hellfire_slab", new SlabBlock(AbstractBlock.Settings.copy(HELLFIRE_STONE)), buildingBlock());
        HELLFIRE_STAIRS = register("hellfire_stairs", new StairsBlock(HELLFIRE_STONE.getDefaultState(), AbstractBlock.Settings.copy(HELLFIRE_STONE)), buildingBlock());
//        HOLIDAY_LEAVES = register("holiday_leaves", null);
        HOLYSTONE_BRICK_SLAB = register("holystone_brick_slab", new SlabBlock(AbstractBlock.Settings.copy(HOLYSTONE_BRICK)), buildingBlock());
        HOLYSTONE_BRICK_STAIRS = register("holystone_brick_stairs", new StairsBlock(HOLYSTONE_BRICK.getDefaultState(), AbstractBlock.Settings.copy(HOLYSTONE_BRICK)), buildingBlock());
        HOLYSTONE_BRICK_WALL = register("holystone_brick_wall", new WallBlock(AbstractBlock.Settings.copy(HOLYSTONE_BRICK)), buildingBlock());
        HOLYSTONE_SLAB = register("holystone_slab", new SlabBlock(AbstractBlock.Settings.copy(HOLYSTONE)), buildingBlock());
        HOLYSTONE_STAIRS = register("holystone_stairs", new StairsBlock(HOLYSTONE.getDefaultState(), AbstractBlock.Settings.copy(HOLYSTONE)), buildingBlock());
        HOLYSTONE_WALL = register("holystone_wall", new WallBlock(AbstractBlock.Settings.copy(HOLYSTONE)), buildingBlock());
...
//        INCUBATOR = register("incubator", null);
        LIGHT_ANGELIC_STONE = register("light_angelic_stone", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).luminance(state -> 11).resistance(1.0f).sounds(BlockSoundGroup.STONE)), buildingBlock());
        LIGHT_ANGELIC_STONE_TRAP = register("light_angelic_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).luminance(state -> 11).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        LIGHT_ANGELIC_SLAB = register("light_angelic_slab", new SlabBlock(AbstractBlock.Settings.copy(LIGHT_ANGELIC_STONE)), buildingBlock());
        LIGHT_ANGELIC_STAIRS = register("light_angelic_stairs", new StairsBlock(LIGHT_ANGELIC_STONE.getDefaultState(), AbstractBlock.Settings.copy(LIGHT_ANGELIC_STONE)), buildingBlock());
        LIGHT_ANGELIC_WALL = register("light_angelic_wall", new WallBlock(AbstractBlock.Settings.copy(LIGHT_ANGELIC_STONE)), buildingBlock());
        LIGHT_CARVED_STONE = register("light_carved_stone", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).luminance(state -> 11).resistance(1.0f).sounds(BlockSoundGroup.STONE)), buildingBlock());
        LIGHT_CARVED_STONE_TRAP = register("light_carved_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).luminance(state -> 11).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        LIGHT_CARVED_SLAB = register("light_carved_slab", new SlabBlock(AbstractBlock.Settings.copy(LIGHT_CARVED_STONE)), buildingBlock());
        LIGHT_CARVED_STAIRS = register("light_carved_stairs", new StairsBlock(LIGHT_CARVED_STONE.getDefaultState(), AbstractBlock.Settings.copy(LIGHT_CARVED_STONE)), buildingBlock());
        LIGHT_CARVED_WALL = register("light_carved_wall", new WallBlock(AbstractBlock.Settings.copy(LIGHT_CARVED_STONE)), buildingBlock());
...
//        LIGHT_GREY_DYED_AERCLOUD = register("light_grey_dyed_aercloud", null);
        LIGHT_HELLFIRE_STONE = register("light_hellfire_stone", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(0.5f).resistance(1.0f).sounds(BlockSoundGroup.STONE)), buildingBlock());
        LIGHT_HELLFIRE_STONE_TRAP = register("light_hellfire_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        LIGHT_HELLFIRE_SLAB = register("light_hellfire_slab", new SlabBlock(AbstractBlock.Settings.copy(LIGHT_HELLFIRE_STONE)), buildingBlock());
        LIGHT_HELLFIRE_STAIRS = register("light_hellfire_stairs", new StairsBlock(LIGHT_HELLFIRE_STONE.getDefaultState(), AbstractBlock.Settings.copy(LIGHT_HELLFIRE_STONE)), buildingBlock());
        LIGHT_HELLFIRE_WALL = register("light_hellfire_wall", new WallBlock(AbstractBlock.Settings.copy(LIGHT_HELLFIRE_STONE)), buildingBlock());
...
//        MAGENTA_DYED_AERCLOUD = register("magenta_dyed_aercloud", null);
        COBBLED_HOLYSTONE_SLAB = register("cobbled_holystone_slab", new SlabBlock(AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
        COBBLED_HOLYSTONE_STAIRS = register("cobbled_holystone_stairs", new StairsBlock(MOSSY_HOLYSTONE.getDefaultState(), AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
        COBBLED_HOLYSTONE_WALL = register("cobbled_holystone_wall", new WallBlock(AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
        MOSSY_HOLYSTONE_SLAB = register("mossy_holystone_slab", new SlabBlock(AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
        MOSSY_HOLYSTONE_STAIRS = register("mossy_holystone_stairs", new StairsBlock(MOSSY_HOLYSTONE.getDefaultState(), AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
        MOSSY_HOLYSTONE_WALL = register("mossy_holystone_wall", new WallBlock(AbstractBlock.Settings.copy(MOSSY_HOLYSTONE)), buildingBlock());
...
//        RED_DYED_AERCLOUD = register("red_dyed_aercloud", null);
        ...
        SENTRY_STONE_TRAP = register("sentry_stone_trap", new Block(AbstractBlock.Settings.of(Material.STONE).hardness(-1.0f).resistance(6000000.0f).sounds(BlockSoundGroup.STONE)));
        SENTRY_SLAB = register("sentry_slab", new SlabBlock(AbstractBlock.Settings.copy(SENTRY_STONE)), buildingBlock());
        SENTRY_STAIRS = register("sentry_stairs", new StairsBlock(SENTRY_STONE.getDefaultState(), AbstractBlock.Settings.copy(SENTRY_STONE)), buildingBlock());
        SENTRY_WALL = register("sentry_wall", new WallBlock(AbstractBlock.Settings.copy(SENTRY_STONE)), buildingBlock());
        LIGHT_SENTRY_SLAB = register("light_sentry_slab", new SlabBlock(AbstractBlock.Settings.copy(LIGHT_SENTRY_STONE)), buildingBlock());
        LIGHT_SENTRY_STAIRS = register("light_sentry_stairs", new StairsBlock(LIGHT_SENTRY_STONE.getDefaultState(), AbstractBlock.Settings.copy(LIGHT_SENTRY_STONE)), buildingBlock());
        LIGHT_SENTRY_WALL = register("light_sentry_wall", new WallBlock(AbstractBlock.Settings.copy(LIGHT_SENTRY_STONE)), buildingBlock());

        final AbstractBlock.Settings SAPLINGS = AbstractBlock.Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS);
        ...
        final AbstractBlock.Settings SKYROOT_WOOD = AbstractBlock.Settings.of(Material.WOOD, MapColor.OAK_TAN).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD);
        SKYROOT_PLANKS = register("skyroot_planks", new Block(SKYROOT_WOOD), buildingBlock());
        SKYROOT_BOOKSHELF = register("skyroot_bookshelf", new Block(AbstractBlock.Settings.of(Material.WOOD).strength(1.5f).sounds(BlockSoundGroup.WOOD)), buildingBlock());
        ...
        SKYROOT_SLAB = register("skyroot_slab", new SlabBlock(AbstractBlock.Settings.copy(SKYROOT_PLANKS)), buildingBlock());
        SKYROOT_STAIRS = register("skyroot_stairs", new StairsBlock(SKYROOT_PLANKS.getDefaultState(), AbstractBlock.Settings.copy(SKYROOT_PLANKS)), buildingBlock());
        SKYROOT_TRAPDOOR = register("skyroot_trapdoor", new AetherTrapdoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)), buildingBlock());
        SKYROOT_DOOR = register("skyroot_door", new AetherDoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_DOOR)), buildingBlock());
        ...
        final AbstractBlock.Settings GOLDEN_OAK_WOOD = AbstractBlock.Settings.of(Material.WOOD, MapColor.RED).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD);
        ...
        GOLDEN_OAK_SLAB = register("golden_oak_slab", new SlabBlock(AbstractBlock.Settings.copy(GOLDEN_OAK_PLANKS)), buildingBlock());
        GOLDEN_OAK_STAIRS = register("golden_oak_stairs", new StairsBlock(GOLDEN_OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.copy(GOLDEN_OAK_PLANKS)), buildingBlock());
        GOLDEN_OAK_TRAPDOOR = register("golden_oak_trapdoor", new AetherTrapdoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)), buildingBlock());
        GOLDEN_OAK_DOOR = register("golden_oak_door", new AetherDoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_DOOR)), buildingBlock());

        ORANGE_SAPLING = register("orange_sapling", new AetherSaplingBlock(new OrangeSaplingGenerator(), SAPLINGS), buildingBlock());
        ...
        final AbstractBlock.Settings ORANGE_WOOD = AbstractBlock.Settings.of(Material.WOOD, MapColor.PINK).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD);
        ...
        ORANGE_TRAPDOOR = register("orange_trapdoor", new AetherTrapdoorBlock(AbstractBlock.Settings.copy(GOLDEN_OAK_TRAPDOOR)), buildingBlock());
        ORANGE_DOOR = register("orange_door", new AetherDoorBlock(AbstractBlock.Settings.copy(GOLDEN_OAK_DOOR)), buildingBlock());

        CRYSTAL_SAPLING = register("crystal_sapling", new AetherSaplingBlock(new CrystalSaplingGenerator(), SAPLINGS.sounds(BlockSoundGroup.GLASS)), buildingBlock());
        ...
        CRYSTAL_TRAPDOOR = register("crystal_trapdoor", new AetherTrapdoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)), buildingBlock());
        CRYSTAL_DOOR = register("crystal_door", new AetherDoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_DOOR)), buildingBlock());


        final AbstractBlock.Settings CRYSTAL_WOOD = AbstractBlock.Settings.of(Material.WOOD, MapColor.LIGHT_GRAY).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD);
        ...
        CRYSTAL_SLAB = register("crystal_slab", new SlabBlock(AbstractBlock.Settings.copy(CRYSTAL_PLANKS)), buildingBlock());
        CRYSTAL_STAIRS = register("crystal_stairs", new StairsBlock(CRYSTAL_PLANKS.getDefaultState(), AbstractBlock.Settings.copy(CRYSTAL_PLANKS)), buildingBlock());
        ...
        final AbstractBlock.Settings ROSE_WISTERIA = AbstractBlock.Settings.of(Material.LEAVES, MapColor.PINK).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
        ...
        final AbstractBlock.Settings FROST_WISTERIA = AbstractBlock.Settings.of(Material.LEAVES, MapColor.LIGHT_BLUE).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
        ...
        final AbstractBlock.Settings LAVENDER_WISTERIA = AbstractBlock.Settings.of(Material.LEAVES, MapColor.MAGENTA).noCollision().strength(0.2f).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning((a, b, c, d) -> false).suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
        ...
        BOREAL_WISTERIA_SAPLING = register("boreal_wisteria_sapling", new AetherSaplingBlock(new BorealWisteriaSaplingGenerator(), SAPLINGS.luminance(state -> 7)), buildingBlock());
        ...
        final AbstractBlock.Settings WISTERIA_WOOD = AbstractBlock.Settings.of(Material.WOOD, MapColor.YELLOW).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD);
        ...
        WISTERIA_SLAB = register("wisteria_slab", new SlabBlock(AbstractBlock.Settings.copy(WISTERIA_PLANKS)), buildingBlock());
        WISTERIA_STAIRS = register("wisteria_stairs", new StairsBlock(WISTERIA_PLANKS.getDefaultState(), AbstractBlock.Settings.copy(WISTERIA_PLANKS)), buildingBlock());
        WISTERIA_TRAPDOOR = register("wisteria_trapdoor", new AetherTrapdoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)), buildingBlock());
        WISTERIA_DOOR = register("wisteria_door", new AetherDoorBlock(AbstractBlock.Settings.copy(Blocks.OAK_DOOR)), buildingBlock());
...
//        YELLOW_DYED_AERCLOUD = register("yellow_dyed_aercloud", null);
        ZANITE_BLOCK = register("zanite_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(3.0f, -1.0f).sounds(BlockSoundGroup.METAL)), buildingBlock());
        BLOCK_OF_GRAVITITE = register("block_of_gravitite", new FloatingBlock(false, AbstractBlock.Settings.of(Material.METAL).strength(3.0f, -1.0f).sounds(BlockSoundGroup.METAL)), buildingBlock());
        ZANITE_CHAIN = register("zanite_chain", new ChainBlock(AbstractBlock.Settings.copy(Blocks.CHAIN)), buildingBlock());
        AMBROSIUM_LANTERN = register("ambrosium_lantern", new AmbrosiumLanternBlock(AbstractBlock.Settings.of(Material.METAL).hardness(3.5f).requiresTool().luminance(state -> 15).resistance(1.0f).sounds(BlockSoundGroup.LANTERN)), buildingBlock());
    ...
    private static AbstractBlock.Settings createLeafPileBlock(BlockSoundGroup sounds) {
        return AbstractBlock.Settings.of(Material.REPLACEABLE_PLANT).strength(0.2f).sounds(sounds).nonOpaque().suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
    }

    private static AbstractBlock.Settings createWisteriaHangerBlock(BlockSoundGroup sounds) {
        return AbstractBlock.Settings.of(Material.DECORATION).strength(0.2f).noCollision().breakInstantly().sounds(sounds).nonOpaque().suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
    }

    private static AbstractBlock.Settings createLeavesProperties(@Nullable Integer luminance, @Nullable BlockSoundGroup sounds) {
        sounds = (sounds != null ? sounds : BlockSoundGroup.GRASS);
        AbstractBlock.Settings properties = AbstractBlock.Settings.of(Material.LEAVES).strength(0.2f).ticksRandomly().sounds(sounds).nonOpaque().allowsSpawning(AetherBlocks::ocelotOrParrot).suffocates(AetherBlocks::never).blockVision(AetherBlocks::never);
        if (luminance != null) {
    ...
    private static CrystalLeavesBlock createCrystalLeavesBlock(@Nullable BlockSoundGroup sounds) {
        sounds = (sounds != null ? sounds : BlockSoundGroup.GLASS);
