...
public class AetherBlocks {
    ...
    private static Action<Block> flammable(int spread, int burn) { return (id, block) -> ((FireBlock) FIRE).registerFlammableBlock(block, spread, burn); }
    ...
    public static final LeavesBlock GOLDEN_OAK_LEAVES = add("golden_oak_leaves", new LeavesBlock(goldenOak.leaves()), flammableLeaves, cutoutMippedRenderLayer);
    ...
    public static final FoodBowlBlock FOOD_BOWL = add("food_bowl", new FoodBowlBlock(of(Material.WOOD, MapColor.DULL_RED).strength(2.5f).sounds(BlockSoundGroup.WOOD).nonOpaque()));
