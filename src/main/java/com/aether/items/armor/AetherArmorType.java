...
public enum AetherArmorType {
    ...
    Gravitite(new AetherArmorMaterial("gravitite", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, AetherItems.GRAVITITE_GEM, 0), 0xe752DB),
    ...
    Obsidian(new AetherArmorMaterial("obsidian", 38, new int[]{4, 8, 10, 4}, 6, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.0F, Blocks.AIR, 0.1F), 0x1B1447),
    Valkyrie(new AetherArmorMaterial("valkyrie", 35, new int[]{4, 8, 10, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1.5F, Blocks.AIR, 0.1F), 0xDDDDDD),
