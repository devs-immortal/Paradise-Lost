...
public class AetherFood {
    ...
    static {
        ...
        GUMMY_SWET = new FoodComponent.Builder().hunger(12).saturationModifier(10.0F).build();
        ENCHANTED_BLUEBERRY = new FoodComponent.Builder().hunger(8).saturationModifier(10.0F).build();
        WHITE_APPLE = new FoodComponent.Builder().saturationModifier(5.0F).alwaysEdible().snack().build();
