...
public class AetherColorProvs {
    ...
    public static void initClient() {
        ...
        ColorProviderRegistry.ITEM.register(((stack, tintIndex) -> 11665355), AetherBlocks.AETHER_GRASS_BLOCK.asItem(), AetherBlocks.AETHER_GRASS.asItem(), AetherBlocks.AETHER_TALL_GRASS.asItem(), AetherBlocks.AETHER_FERN.asItem(), AetherBlocks.AETHER_BUSH.asItem());
    }
}
