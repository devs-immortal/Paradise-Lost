...
public class MoaEntity extends SaddleMountEntity implements JumpingMount, Tameable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new WanderAroundFarGoal(this, 0.65F, 0.1F)); //WanderGoal
        this.goalSelector.add(3, new TemptGoal(this, 1.0D, Ingredient.ofItems(AetherItems.NATURE_STAFF), false));
