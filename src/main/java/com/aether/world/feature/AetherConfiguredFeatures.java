...
public class AetherConfiguredFeatures {
    ...
    public static class Configs {
        ...
        //public static final TreeFeatureConfig GOLDEN_OAK_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(AetherBlocks.GOLDEN_OAK_LOG.getDefaultState()), new LargeOakTrunkPlacer(6, 15, 0), new SimpleBlockStateProvider(AetherBlocks.GOLDEN_OAK_LEAVES.getDefaultState()), new SimpleBlockStateProvider(AetherBlocks.GOLDEN_OAK_SAPLING.getDefaultState()), new LargeOakFoliagePlacer(ConstantIntProvider.create(4), ConstantIntProvider.create(4), 4), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().heightmap(Heightmap.Type.MOTION_BLOCKING).build();
