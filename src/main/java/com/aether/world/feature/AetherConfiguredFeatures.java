...
public class AetherConfiguredFeatures {
    ...
    public static class Configs {
        ...
        public static final TreeFeatureConfig WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(AetherBlocks.SKYROOT_LOG.getDefaultState()), new SimpleBlockStateProvider(AetherBlocks.WISTERIA_LEAVES.getDefaultState()), new SpruceFoliagePlacer(UniformIntDistribution.of(2, 0), UniformIntDistribution.of(1, 2), UniformIntDistribution.of(2, 1)), new StraightTrunkPlacer(6, 4, 0), new TwoLayersFeatureSize(4, 0, 4))).ignoreVines().build();
