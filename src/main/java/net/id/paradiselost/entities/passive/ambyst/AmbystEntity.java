...
public class AmbystEntity extends ParadiseLostAnimalEntity implements AngledModelEntity {
    ...
    static {
        SENSORS = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, ParadiseLostEntityTypes.WEATHER_SENSOR, ParadiseLostEntityTypes.FINDLOG_SENSOR);
        MEMORY_MODULES = ImmutableList.of(ParadiseLostEntityTypes.IS_RAINING_MEMORY, ParadiseLostEntityTypes.LOG_OPENING_MEMORY, ParadiseLostEntityTypes.LOG_MEMORY, MemoryModuleType.BREED_TARGET, MemoryModuleType.MOBS, MemoryModuleType.VISIBLE_MOBS, MemoryModuleType.NEAREST_VISIBLE_PLAYER, MemoryModuleType.NEAREST_VISIBLE_TARGETABLE_PLAYER, MemoryModuleType.LOOK_TARGET, MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.PATH, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.ATTACK_COOLING_DOWN, MemoryModuleType.NEAREST_VISIBLE_ADULT, MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.PLAY_DEAD_TICKS, MemoryModuleType.NEAREST_ATTACKABLE, MemoryModuleType.TEMPTING_PLAYER, MemoryModuleType.TEMPTATION_COOLDOWN_TICKS, MemoryModuleType.IS_TEMPTED, MemoryModuleType.HAS_HUNTING_COOLDOWN);
    }
}
