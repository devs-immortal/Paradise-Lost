...
public class ParadiseLostComponents implements EntityComponentInitializer {
    ...
    public static final ComponentKey<ConditionManager> CONDITION_MANAGER_KEY = ComponentRegistry.getOrCreate(ParadiseLost.locate("condition_manager"), ConditionManager.class);
