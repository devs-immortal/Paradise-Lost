...
public class CloudCarverConfig extends CarverConfig {
    public static final Codec<CloudCarverConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BlockStateProvider.TYPE_CODEC.fieldOf("cloud_block").forGetter((cloudCarverConfig -> cloudCarverConfig.cloudState)),
            FloatProvider.VALUE_CODEC.fieldOf("yaw_multiplier").forGetter(carverConfig -> carverConfig.yawMultiplier),
            FloatProvider.VALUE_CODEC.fieldOf("yaw_pitch_ratio").forGetter(carverConfig -> carverConfig.yawMultiplier),
