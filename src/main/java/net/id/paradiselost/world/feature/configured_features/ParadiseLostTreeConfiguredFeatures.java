...
public class ParadiseLostTreeConfiguredFeatures extends ParadiseLostConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<LongFeatureConfig, ?>> MOTTLED_FALLEN_LOG = register("mottled_fallen_log", ParadiseLostFeatures.FALLEN_PILLAR_FEATURE, new LongFeatureConfig(UniformIntProvider.create(3, 5), BlockStateProvider.of(MOTTLED_SKYROOT_LOG), BlockStateProvider.of(GRASS), BlockStateProvider.of(ROOTCAP), 0.3F, 0.15F, Configs.GENERIC_FLOOR_WHITELIST));
    public static final RegistryEntry<ConfiguredFeature<LongFeatureConfig, ?>> MOTTLED_HOLLOW_FALLEN_LOG = register("mottled_hollow_fallen_log", ParadiseLostFeatures.FALLEN_PILLAR_FEATURE, new LongFeatureConfig(UniformIntProvider.create(3, 5), BlockStateProvider.of(MOTTLED_SKYROOT_FALLEN_LOG), BlockStateProvider.of(GRASS_FLOWERING), BlockStateProvider.of(ROOTCAP), 0.4F, 0.25F, Configs.GENERIC_FLOOR_WHITELIST));
    ...
    private static class Configs extends ParadiseLostConfiguredFeatures.Configs{
        ...
        private static final TreeFeatureConfig MOTTLED_SKYROOT_CONFIG = generateTree(
                MOTTLED_SKYROOT_LOG.getDefaultState(), SKYROOT_LEAVES.getDefaultState(), DIRT.getDefaultState(),
