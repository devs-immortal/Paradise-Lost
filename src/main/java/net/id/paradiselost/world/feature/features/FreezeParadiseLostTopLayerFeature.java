...
public class FreezeParadiseLostTopLayerFeature extends Feature<DefaultFeatureConfig> {

    public FreezeParadiseLostTopLayerFeature(Codec<DefaultFeatureConfig> configCodec) {
        super(configCodec);
    }
