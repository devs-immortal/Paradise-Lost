...
public class ParadiseLostVegetationPlacedFeatures extends ParadiseLostPlacedFeatures {
     ...
     */
    // Default
    public static final RegistryEntry<PlacedFeature> BUSH = register("paradise_lost_bush", ParadiseLostVegetationConfiguredFeatures.BUSH, SPREAD_32_ABOVE, CountMultilayerPlacementModifier.of(2), ChancePlacementModifier.of(4));
    public static final RegistryEntry<PlacedFeature> DENSE_BUSH = register("paradise_lost_dense_bush", ParadiseLostVegetationConfiguredFeatures.DENSE_BUSH, CountMultilayerPlacementModifier.of(3), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
    public static final RegistryEntry<PlacedFeature> FLOWERS = register("paradise_lost_flowers", ParadiseLostVegetationConfiguredFeatures.FLOWERS, CountPlacementModifier.of(3), RarityFilterPlacementModifier.of(32), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
    public static final RegistryEntry<PlacedFeature> GRASS = register("paradise_lost_grass", ParadiseLostVegetationConfiguredFeatures.GRASS_BUSH, CountPlacementModifier.of(10), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.belowTop(0)), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
    public static final RegistryEntry<PlacedFeature> GRASS_BONEMEAL = register("paradise_lost_grass_bonemeal", ParadiseLostVegetationConfiguredFeatures.GRASS_BONEMEAL, PlacedFeatures.isAir());
    public static final RegistryEntry<PlacedFeature> TALL_GRASS = register("paradise_lost_tall_grass", ParadiseLostVegetationConfiguredFeatures.TALL_GRASS_BUSH, CountPlacementModifier.of(3), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.belowTop(0)), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
