...
public class ParadiseLostSaplingGenerators {
    ...
    public static final SaplingGenerator MENTH;
    ...
    static {
        ...
        MENTH = new SaplingGenerator("pl_menth", 0.0F, Optional.empty(), Optional.empty(), Optional.of(ParadiseLostTreeConfiguredFeatures.MENTH_TREE), Optional.empty(), Optional.empty(), Optional.empty());
