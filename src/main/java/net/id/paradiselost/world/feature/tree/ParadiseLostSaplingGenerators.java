...
public class ParadiseLostSaplingGenerators {
    ...
    static {
        ...
        ORANGE = new SaplingGenerator("pl_orange", 0.1F, Optional.empty(), Optional.empty(), Optional.of(ParadiseLostTreeConfiguredFeatures.ORANGE_TREE), Optional.empty(), Optional.empty(), Optional.empty());
