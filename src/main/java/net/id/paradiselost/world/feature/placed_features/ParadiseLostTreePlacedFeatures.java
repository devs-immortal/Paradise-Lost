...
public class ParadiseLostTreePlacedFeatures extends ParadiseLostPlacedFeatures {
     ...
     */
    // Default
    public static final RegistryEntry<PlacedFeature> SKYROOT_TREE = register("skyroot_tree", ParadiseLostTreeConfiguredFeatures.SKYROOT_TREE, placed(SKYROOT_SAPLING));
    ...
    public static final RegistryEntry<PlacedFeature> FANCY_SKYROOT_TREE = register("fancy_skyroot_tree", ParadiseLostTreeConfiguredFeatures.FANCY_SKYROOT_TREE, placed(SKYROOT_SAPLING));
    // Tree Assortments
    ...
    public static final RegistryEntry<PlacedFeature> THICKET_TREES = register("thicket_trees", ParadiseLostTreeConfiguredFeatures.THICKET_TREES, CountMultilayerPlacementModifier.of(14), CountPlacementModifier.of(UniformIntProvider.create(0, 6)));
    ...
    // Fallen leaves
    public static final RegistryEntry<PlacedFeature> FALLEN_LEAVES = register("fallen_leaves", ParadiseLostTreeConfiguredFeatures.FALLEN_LEAVES, SPREAD_32_ABOVE, PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, CountPlacementModifier.of(3), ChancePlacementModifier.of(5), BlockFilterPlacementModifier.of(BlockPredicate.matchingBlocks(PARADISE_LOST_GROUND)));
    public static final RegistryEntry<PlacedFeature> ALT_FALLEN_LEAVES = register("alt_fallen_leaves", ParadiseLostTreeConfiguredFeatures.ALT_FALLEN_LEAVES, SPREAD_32_ABOVE, PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, CountPlacementModifier.of(3), ChancePlacementModifier.of(5), BlockFilterPlacementModifier.of(BlockPredicate.matchingBlocks(PARADISE_LOST_GROUND)));
