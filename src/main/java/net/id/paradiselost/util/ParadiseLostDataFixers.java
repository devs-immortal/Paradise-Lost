...
public final class ParadiseLostDataFixers /*implements DataFixerAdder*/ {
    ...
    TODO FEATURES OF A BLOCK SHOULD SHARE STRING ID
        e.g PlacedFeature PARADISE_LOST_GRASS_BUSH (id: paradise_lost:aether_grass) -> GRASS_PLANT (id: paradise_lost:grass_plant)
    ...
    public void addDataFixers(@NotNull DataFixerApi dataFixerApi) {
        ...
        builder.addFixer(new BlockNameFix(theDarkAges, "ParadiseLost -> Paradise Lost Blocks") {
            @Override
