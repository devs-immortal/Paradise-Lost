...
public class ParadiseLostBlocks {
    ...
    public static final DirectionalParadiseLostCloudBlock GREEN_CLOUD = add("green_cloud", new DirectionalParadiseLostCloudBlock(cloud().mapColor(MapColor.EMERALD_GREEN)), translucentRenderLayer);
    ...
    public static final PalaceDoorExtensionBlock PALACE_DOOR_EXTENSION = add("palace_door_extension", new PalaceDoorExtensionBlock(copy(BEDROCK).nonOpaque().mapColor(MapColor.YELLOW)));
