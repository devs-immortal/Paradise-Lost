...
public class ParadiseLostBlocks {
    ...
    public static final PopomParadiseLostCloudBlock POPOM_CLOUD = add("popom_cloud", new PopomParadiseLostCloudBlock(cloud().mapColor(MapColor.PINK)), translucentRenderLayer);
