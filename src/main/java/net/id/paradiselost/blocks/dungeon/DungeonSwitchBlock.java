...
import net.id.paradiselost.blocks.blockentity.dungeon.DungeonSwitchBlockEntity;
...
//        return world.isClient & type == ParadiseLostBlockEntityTypes.DUNGEON_SWITCH ? (world1, pos, state1, blockEntity) -> ((DungeonSwitchBlockEntity) blockEntity).clientTick() : null;
        return null;
    }
