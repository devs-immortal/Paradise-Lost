...
import net.id.paradiselost.util.InventoryWrapper;
...
public abstract class ParadiseLostBlockEntity extends BlockEntity implements InventoryWrapper, SidedInventory {

    protected final DefaultedList<ItemStack> inventory;
    protected HopperStrategy hopperStrategy;

    public ParadiseLostBlockEntity(BlockEntityType<?> type, BlockPos pos, BlockState state, int invSize, HopperStrategy hopperStrategy) {
