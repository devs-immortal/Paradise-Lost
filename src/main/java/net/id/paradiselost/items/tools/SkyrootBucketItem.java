...
public class SkyrootBucketItem extends Item {
    ...
    public ItemStack onBucketContentsConsumed(ItemStack stack, World world, PlayerEntity playerEntity) {
        ...
        return stack.isEmpty() ? new ItemStack(ParadiseLostItems.SKYROOT_BUCKET) : stack;
    }
    ...
    public UseAction getUseAction(ItemStack stack) {
        if (stack.getItem() != ParadiseLostItems.SKYROOT_WATER_BUCKET && stack.getItem() != ParadiseLostItems.SKYROOT_BUCKET) {
    ...
    protected ItemStack emptyBucket(ItemStack stackIn, PlayerEntity playerIn) {
        return !playerIn.getAbilities().creativeMode ? new ItemStack(ParadiseLostItems.SKYROOT_BUCKET) : stackIn;
    }
