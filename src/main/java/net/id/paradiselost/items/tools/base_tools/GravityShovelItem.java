...
public class GravityShovelItem extends ShovelItem {
    public GravityShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
