...
public class GravityPickaxeItem extends PickaxeItem {
    public GravityPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
