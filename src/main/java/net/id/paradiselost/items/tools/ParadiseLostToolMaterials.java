...
public class ParadiseLostToolMaterials {
    ...
    public static final ToolMaterial SURTRUM = ToolMaterialsAccessor.callInit("PARADISE_LOST_SURTRUM", -1,
            MiningLevels.DIAMOND, 827, 7.0f, 3f, 16, IngredientUtil.itemIngredient(ParadiseLostItems.OLVITE));
