...
public class ParadiseLostToolMaterials {
    ...
    public static final ToolMaterial SOUL_BLADE = create(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 636, 6.5f, 1.5f, 17, () -> Ingredient.ofItems(ParadiseLostItems.BLOOMED_CALCITE));
