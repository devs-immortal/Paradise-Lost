...
/**
 * An API intended to aid creation of {@code MoaRace}s, and register spawn probabilities based on biome and mating. It
 * also has several other useful tools regarding Moas.
 * <br>
 * ~ Jack
 *
...
public class MoaAPI {
    ...
    /**
     * The "registry" for storing {@code MoaRace} breeding information. It's really just a set of all
     * {@code MatingEntries}.
     *
    ...
    /**
     * Registers a new mating entry based on the input parameters. This automatically adds a check for these given
     * parents.
     *
     * @param child     The {@code MoaRace} to be created
    ...
    /**
     * Registers a new mating entry based on the input parameters. This does not automatically complete a parent check.
     *
     * @param child     The {@code MoaRace} to be created
     * @param predicate Returns {@code true} if the child can be created by breeding.
     */
     ...
     * @return A {@code MoaRace} registered to spawn in the given biome, distributed proportionally based on percent
     * chance of spawning.
     */
    @NotNull
    ...
    /**
     * @return A random {@code MoaRace} that can be bred from the provided context. If none can be generated, the
     * returned race is a random selection of the parents' races.
     * <br>Note: This may not return a fallback moa unless both parents' races are
     * {@link MoaAPI#FALLBACK_MOA}, or some breeding for the {@code FALLBACK_MOA} is registered, which is not the case
     * by default.
     */
    ...
    /**
     * Pretty much "classes" for MoaRaces. Such that a Moa that could be considered a "tank" would be fairly slow, for
     * example. The classes affect speed, gliding speed, jump strength, and max health.
     */
     ...
     *
     * @param defaultAffinity The default "affinity" of the MoaRace. What it improves on most
    ...
    private static class SpawnBucket {
        ...
        /**
         * Adds a MoaRace and Spawn weighting pair to this SpawnBucket. A higher weight is more likely to be chosen.
         */
        ...
        /**
         * @return A random MoaRace. Races with higher weights in this bucket are more likely. If no races have been
         * added to this bucket, returns a {@link MoaAPI#FALLBACK_MOA}
         */
