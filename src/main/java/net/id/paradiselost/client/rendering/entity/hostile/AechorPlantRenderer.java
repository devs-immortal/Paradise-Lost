...
import net.id.paradiselost.client.model.entity.ParadiseLostPlantModel;
...
public class AechorPlantRenderer extends MobEntityRenderer<AechorPlantEntity, ParadiseLostPlantModel> {
    ...
    public AechorPlantRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new ParadiseLostPlantModel(renderManager.getPart(ParadiseLostModelLayers.AECHOR_PLANT)), 0.3F);
    }
