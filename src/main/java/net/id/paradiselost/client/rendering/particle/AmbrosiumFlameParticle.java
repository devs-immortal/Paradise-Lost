...
public class AmbrosiumFlameParticle extends AbstractSlowingParticle {
    AmbrosiumFlameParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
