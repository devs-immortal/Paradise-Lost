...
public class AetherConfiguredFeatures extends ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> SCATTERED_TREES = register("scattered_trees", Feature.RANDOM_SELECTOR.configure(Configs.SCATTERED_TREES_CONFIG).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(10)))).spreadHorizontally().repeatRandomly(8);
