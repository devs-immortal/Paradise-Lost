...
public class AetherConfiguredFeatures extends ConfiguredFeatures {
    ...
    public static class Configs {
        ...
        public static final TreeFeatureConfig SKYROOT_SHRUB_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(SKYROOT_LOG.getDefaultState()), new StraightTrunkPlacer(1, 1, 0), new SimpleBlockStateProvider(SKYROOT_LEAVES.getDefaultState()), new SimpleBlockStateProvider(SKYROOT_SAPLING.getDefaultState()), new BlobFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
