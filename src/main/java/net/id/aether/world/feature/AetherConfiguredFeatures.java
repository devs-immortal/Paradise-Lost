...
public class AetherConfiguredFeatures extends ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> PLATEAU_TREES = register("plateau_trees", Feature.RANDOM_SELECTOR.configure(Configs.PLATEAU_TREES_CONFIG).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(3))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)))).spreadHorizontally().repeatRandomly(1);
    ...
    public static final ConfiguredFeature<?, ?> THICKET_TREES = register("thicket_trees", Feature.RANDOM_SELECTOR.configure(Configs.THICKET_TREES_CONFIG).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(20)))).spreadHorizontally().repeatRandomly(5);
    ...
    public static final ConfiguredFeature<?, ?> FALLEN_ROSE_LEAVES = register("fallen_rose_leaves", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(ROSE_WISTERIA_LEAF_PILE.getDefaultState(), 10).add(ROSE_WISTERIA_LEAVES.getDefaultState().with(LeavesBlock.PERSISTENT, true), 2).build()), UniformIntProvider.create(4, 10), ConstantIntProvider.create(7), UniformIntProvider.create(3, 6), 1.2)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(3)/*.spreadHorizontally()*/));
    public static final ConfiguredFeature<?, ?> FALLEN_LAVENDER_LEAVES = register("fallen_lavender_leaves", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(LAVENDER_WISTERIA_LEAF_PILE.getDefaultState(), 10).add(LAVENDER_WISTERIA_LEAVES.getDefaultState().with(LeavesBlock.PERSISTENT, true), 2).build()), UniformIntProvider.create(4, 10), ConstantIntProvider.create(7), UniformIntProvider.create(3, 6), 1.2)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(3)/*.spreadHorizontally()*/));

    public static final ConfiguredFeature<?, ?> RAINBOW_MALT_SPRIGS = register("rainbow_malt_sprigs", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(MALT_SPRIG.getDefaultState()), UniformIntProvider.create(3, 13), ConstantIntProvider.create(5), UniformIntProvider.create(3, 4), 1.4)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(1).spreadHorizontally()));
    ...
    public static final ConfiguredFeature<?, ?> SHIELD_FALLEN_LEAVES = register("shield_fallen_leaves", Feature.RANDOM_PATCH.configure(Configs.FALLEN_LEAVES_CONFIG).range(Decorators.BOTTOM_TO_TOP).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(2)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(4)))/*.spreadHorizontally()*/.repeatRandomly(3)));
    public static final ConfiguredFeature<?, ?> SHIELD_ROCKS = register("shield_rocks", Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(COBBLED_HOLYSTONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.BOTTOM), 10).add(COBBLED_HOLYSTONE.getDefaultState(), 4).build()), new SimpleBlockPlacer()).whitelist(Set.of(HOLYSTONE, COBBLED_HOLYSTONE, MOSSY_HOLYSTONE)).spreadX(9).spreadZ(9).tries(96).cannotProject().build()).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(3)).repeatRandomly(3)/*.spreadHorizontally()*/));

    public static final ConfiguredFeature<?, ?> PLATEAU_FOLIAGE = register("plateau_foliage", Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(AETHER_GRASS.getDefaultState(), 20).add(AETHER_FERN.getDefaultState(), 15).add(AetherBlocks.AETHER_BUSH.getDefaultState(), 13).add(AETHER_GRASS_FLOWERING.getDefaultState(), 5).build()), new SimpleBlockPlacer()).build()).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(3))).repeatRandomly(4)/*.spreadHorizontally()*/);
    public static final ConfiguredFeature<?, ?> PLATEAU_FLOWERING_GRASS = register("plateau_flowering_grass", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(AETHER_GRASS_FLOWERING.getDefaultState()), UniformIntProvider.create(3, 10), ConstantIntProvider.create(5), UniformIntProvider.create(3, 6), 1.5)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(5)/*.spreadHorizontally()*/));
    public static final ConfiguredFeature<?, ?> PLATEAU_SHAMROCK = register("plateau_shamrock", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(MALT_SPRIG.getDefaultState()), UniformIntProvider.create(2, 6), ConstantIntProvider.create(5), UniformIntProvider.create(4, 7), 1.4)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(6))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(2).spreadHorizontally()));
    ...
    public static final ConfiguredFeature<?, ?> SHIELD_FLAX = register("shield_flax", Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(WILD_FLAX.getDefaultState()), new DoublePlantPlacer()).spreadX(12).spreadZ(12).spreadY(5).tries(96).whitelist(Set.of(HOLYSTONE, COBBLED_HOLYSTONE, MOSSY_HOLYSTONE)).build()).range(Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(5)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(2)).repeatRandomly(4)/*.spreadHorizontally()*/)));
    ...
    public static final ConfiguredFeature<?, ?> THICKET_FALLEN_LOG = register("thicket_fallen_log", Configs.FALLEN_PILLAR_FEATURE.configure(new LongFeatureConfig(UniformIntProvider.create(3, 6), new SimpleBlockStateProvider(SKYROOT_LOG.getDefaultState()), new SimpleBlockStateProvider(LIVERWORT_CARPET.getDefaultState()), new SimpleBlockStateProvider(LIVERWORT_CARPET.getDefaultState()), 0.5F, 0.35F, GENERIC_FLOOR_WHITELIST)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(3))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(2))).repeatRandomly(2).spreadHorizontally());

    public static final ConfiguredFeature<?, ?> THICKET_LIVERWORT = register("thicket_liverwort", Configs.GROUNDCOVER_FEATURE.configure(new GroundcoverFeatureConfig(new SimpleBlockStateProvider(LIVERWORT.getDefaultState()), UniformIntProvider.create(0, 2), UniformIntProvider.create(0, 1))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1))).repeatRandomly(2).spreadHorizontally());
    public static final ConfiguredFeature<?, ?> THICKET_LIVERWORT_CARPET = register("thicket_liverwort_carpet", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(LIVERWORT_CARPET.getDefaultState()), UniformIntProvider.create(1, 4), ConstantIntProvider.create(5), UniformIntProvider.create(5, 8), 1.3)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(6))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1))));
    public static final ConfiguredFeature<?, ?> THICKET_SHAMROCK = register("thicket_shamrock", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(SHAMROCK.getDefaultState()), UniformIntProvider.create(2, 6), ConstantIntProvider.create(5), UniformIntProvider.create(4, 7), 1.3)).range(ConfiguredFeatures.Decorators.BOTTOM_TO_TOP).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(8))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1))));
    ...
    public static class Configs {
        ...
        public static final TreeFeatureConfig SKYROOT_SHRUB_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(SKYROOT_LOG.getDefaultState()), new StraightTrunkPlacer(1, 1, 0), new SimpleBlockStateProvider(SKYROOT_LEAVES.getDefaultState()), new SimpleBlockStateProvider(SKYROOT_SAPLING.getDefaultState()), new BlobFoliagePlacer(UniformIntProvider.create(2, 4), ConstantIntProvider.create(0), 2), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
        ...
        //Wisterias
        public static final TreeFeatureConfig ROSE_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(5, 9), UniformIntProvider.create(1, 3), UniformIntProvider.create(2, 5), UniformIntProvider.create(1, 3), ConstantFloatProvider.create(0.334F), 3, 3, 2), new SimpleBlockStateProvider(ROSE_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(ROSE_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 4), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig LAVENDER_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(5, 9), UniformIntProvider.create(1, 3), UniformIntProvider.create(2, 5), UniformIntProvider.create(1, 3), ConstantFloatProvider.create(0.334F), 3, 3, 2), new SimpleBlockStateProvider(LAVENDER_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(LAVENDER_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 4), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig FROST_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(5, 9), UniformIntProvider.create(1, 3), UniformIntProvider.create(2, 5), UniformIntProvider.create(1, 3), ConstantFloatProvider.create(0.334F), 3, 3, 2), new SimpleBlockStateProvider(FROST_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(FROST_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 4), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig BOREAL_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(7, 11), UniformIntProvider.create(2, 4), UniformIntProvider.create(2, 5), UniformIntProvider.create(2, 4), ConstantFloatProvider.create(0.334F), 4, 5, 2), new SimpleBlockStateProvider(BOREAL_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(BOREAL_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 5), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig FANCY_ROSE_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(10, 17), UniformIntProvider.create(3, 7), UniformIntProvider.create(3, 6), UniformIntProvider.create(3, 7), ConstantFloatProvider.create(0.334F), 6, 5, 3), new SimpleBlockStateProvider(ROSE_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(ROSE_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 5), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig FANCY_LAVENDER_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(10, 17), UniformIntProvider.create(3, 7), UniformIntProvider.create(3, 6), UniformIntProvider.create(3, 7), ConstantFloatProvider.create(0.334F), 6, 5, 3), new SimpleBlockStateProvider(LAVENDER_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(LAVENDER_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 5), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig FANCY_FROST_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(10, 17), UniformIntProvider.create(3, 7), UniformIntProvider.create(3, 6), UniformIntProvider.create(3, 7), ConstantFloatProvider.create(0.334F), 6, 5, 3), new SimpleBlockStateProvider(FROST_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(FROST_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 5), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        public static final TreeFeatureConfig FANCY_BOREAL_WISTERIA_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG.getDefaultState()), new WisteriaTrunkPlacer(UniformIntProvider.create(13, 21), UniformIntProvider.create(3, 9), UniformIntProvider.create(4, 10), UniformIntProvider.create(3, 9), ConstantFloatProvider.create(0.334F), 7, 6, 3), new SimpleBlockStateProvider(BOREAL_WISTERIA_LEAVES.getDefaultState()), new SimpleBlockStateProvider(BOREAL_WISTERIA_SAPLING.getDefaultState()), new WisteriaFoliagePlacer(UniformIntProvider.create(3, 6), UniformIntProvider.create(0, 1)), new TwoLayersFeatureSize(3, 0, 3))).ignoreVines().build();
        ...
        public static final RandomFeatureConfig THICKET_TREES_CONFIG = new RandomFeatureConfig(
                ImmutableList.of(Feature.TREE.configure(ROSE_WISTERIA_CONFIG).withChance(0.0001F), Feature.TREE.configure(LAVENDER_WISTERIA_CONFIG).withChance(0.0001F), Feature.TREE.configure(GOLDEN_OAK_CONFIG).withChance(0.0025F), Feature.TREE.configure(SKYROOT_SHRUB_CONFIG).withChance(0.15F), Feature.TREE.configure(SKYROOT_CONFIG).withChance(0.075F)),
        ...
        public static final RandomFeatureConfig PLATEAU_TREES_CONFIG = new RandomFeatureConfig(
                ImmutableList.of(Feature.TREE.configure(ORANGE_TREE_WILD_CONFIG).withChance(0.05F), Feature.TREE.configure(DWARF_MOTTLED_SKYROOT_CONFIG).withChance(0.225F)),
                Feature.TREE.configure(Configs.SKYROOT_SHRUB_CONFIG)
        );
