...
public class AetherConfiguredFeatures extends ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> FALLEN_ROSE_LEAVES = register("fallen_rose_leaves", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(ROSE_WISTERIA_LEAF_PILE.getDefaultState(), 10).add(ROSE_WISTERIA_LEAVES.getDefaultState().with(LeavesBlock.PERSISTENT, true), 2).build()), UniformIntProvider.create(4, 10), ConstantIntProvider.create(7), UniformIntProvider.create(3, 6), 1.2)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(3).spreadHorizontally()));
    public static final ConfiguredFeature<?, ?> FALLEN_LAVENDER_LEAVES = register("fallen_lavender_leaves", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(LAVENDER_WISTERIA_LEAF_PILE.getDefaultState(), 10).add(LAVENDER_WISTERIA_LEAVES.getDefaultState().with(LeavesBlock.PERSISTENT, true), 2).build()), UniformIntProvider.create(4, 10), ConstantIntProvider.create(7), UniformIntProvider.create(3, 6), 1.2)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(3).spreadHorizontally()));

    public static final ConfiguredFeature<?, ?> RAINBOW_MALT_SPRIGS = register("rainbow_malt_sprigs", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(MALT_SPRIG.getDefaultState()), UniformIntProvider.create(3, 13), ConstantIntProvider.create(5), UniformIntProvider.create(3, 4), 1.4)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(1).spreadHorizontally()));
    ...
    public static final ConfiguredFeature<?, ?> PLATEAU_FLOWERING_GRASS = register("plateau_flowering_grass", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(AETHER_GRASS_FLOWERING.getDefaultState()), UniformIntProvider.create(3, 10), ConstantIntProvider.create(5), UniformIntProvider.create(3, 6), 1.5)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(5).spreadHorizontally()));
    public static final ConfiguredFeature<?, ?> PLATEAU_SHAMROCK = register("plateau_shamrock", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(MALT_SPRIG.getDefaultState()), UniformIntProvider.create(2, 6), ConstantIntProvider.create(5), UniformIntProvider.create(4, 7), 1.4)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(6))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1)).repeatRandomly(2).spreadHorizontally()));
    ...
    public static final ConfiguredFeature<?, ?> THICKET_LIVERWORT_CARPET = register("thicket_liverwort_carpet", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(LIVERWORT_CARPET.getDefaultState()), UniformIntProvider.create(1, 4), ConstantIntProvider.create(5), UniformIntProvider.create(5, 8), 1.3)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(6))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1))));
    public static final ConfiguredFeature<?, ?> THICKET_SHAMROCK = register("thicket_shamrock", Configs.ORGANIC_GROUNDCOVER_FEATURE.configure(new ProjectedOrganicCoverConfig(new SimpleBlockStateProvider(SHAMROCK.getDefaultState()), UniformIntProvider.create(2, 6), ConstantIntProvider.create(5), UniformIntProvider.create(4, 7), 1.3)).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(8))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(1))));
