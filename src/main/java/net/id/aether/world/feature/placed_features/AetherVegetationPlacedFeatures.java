...
public class AetherVegetationPlacedFeatures extends AetherPlacedFeatures{
    ...
    public static final PlacedFeature AETHER_GRASS_BONEMEAL = register("aether_grass_bonemeal", AetherVegetationConfiguredFeatures.SINGLE_PIECE_OF_AETHER_GRASS.withInAirFilter());
    ...
    public static final PlacedFeature FLUTEGRASS_BONEMEAL = register("flutegrass_bonemeal", AetherVegetationConfiguredFeatures.SINGLE_PIECE_OF_FLUTEGRASS.withInAirFilter());
