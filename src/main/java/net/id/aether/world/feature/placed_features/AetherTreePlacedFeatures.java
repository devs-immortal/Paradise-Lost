...
public class AetherTreePlacedFeatures extends AetherPlacedFeatures{
    ...
    public static final PlacedFeature THICKET_TREES = register("thicket_trees", AetherTreeConfiguredFeatures.THICKET_TREES.withPlacement(CountMultilayerPlacementModifier.of(14), CountPlacementModifier.of(UniformIntProvider.create(0, 6))));
