...
public class AetherTreePlacedFeatures extends AetherPlacedFeatures{
    ...
    // Tree Assortments
    public static final PlacedFeature SCATTERED_TREES = register("scattered_trees", CF_SCATTERED_TREES.withPlacement(CountMultilayerPlacementModifier.of(10), CountPlacementModifier.of(UniformIntProvider.create(0, 7))));
    public static final PlacedFeature SHIELD_TREES = register("shield_trees", CF_SHIELD_TREES.withPlacement(CountMultilayerPlacementModifier.of(6), CountPlacementModifier.of(UniformIntProvider.create(0, 5))));
    ...
    public static final PlacedFeature PLATEAU_TREES = register("plateau_trees", CF_PLATEAU_TREES.withPlacement(new ChancePlacementModifier(ConstantIntProvider.create(3)), CountMultilayerPlacementModifier.of(1), CountPlacementModifier.of(UniformIntProvider.create(0, 1))));
    ...
    public static final PlacedFeature THICKET_TREES = register("thicket_trees", CF_THICKET_TREES.withPlacement(CountMultilayerPlacementModifier.of(20), CountPlacementModifier.of(UniformIntProvider.create(0, 5))));
    public static final PlacedFeature RAINBOW_FOREST_TREES = register("wisteria_woods_trees", CF_RAINBOW_FOREST_TREES.withPlacement(CountMultilayerPlacementModifier.of(17), CountPlacementModifier.of(UniformIntProvider.create(0, 4))));
    // Fallen leaves
    ...
    // Logs & Stumps
    public static final PlacedFeature THICKET_FALLEN_LOG = register("thicket_fallen_log", AetherTreeConfiguredFeatures.THICKET_FALLEN_LOG.withPlacement(new ChancePlacementModifier(ConstantIntProvider.create(3)), CountMultilayerPlacementModifier.of(2), CountPlacementModifier.of(UniformIntProvider.create(0, 2))));
