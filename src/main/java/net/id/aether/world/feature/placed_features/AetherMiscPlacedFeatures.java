...
public class AetherMiscPlacedFeatures extends AetherPlacedFeatures{
    ...
    // Tundra
    public static final PlacedFeature TUNDRA_SPIRES = register("tundra_spires", AetherMiscConfiguredFeatures.TUNDRA_SPIRES.withPlacement(ChancePlacementModifier.of(9), CountMultilayerPlacementModifier.of(1), CountPlacementModifier.of(UniformIntProvider.create(0, 10))));
