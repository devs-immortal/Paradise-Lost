...
public class AetherBlocks {
    ...
    */
    ...
    private static Action<Block> flammable(int spread, int burn) {
        return (id, block) -> FlammableBlockRegistry.getDefaultInstance().add(block, spread, burn);
    }

    private static Action<Block> strippedFrom(Block original) {
        return (id, stripped) -> StrippableBlockRegistry.register(original, stripped);
    }

    private static Action<Block> tillable() {
        return (id, block) -> addTillAction(block);
    }

    private static Action<Block> flattenable() {
        return (id, block) -> addFlattenAction(block);
    }
