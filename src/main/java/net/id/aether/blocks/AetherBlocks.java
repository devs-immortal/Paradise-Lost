...
public class AetherBlocks {
    ...
    */
    ...
    public static final ZaniteRoseBlock WEEPING_CLOUDBURST = add("zanite_rose", new ZaniteRoseBlock(copy(SUGAR_CANE).mapColor(MapColor.PALE_PURPLE)), cutoutMippedRenderLayer);
