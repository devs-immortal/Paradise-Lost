...
//        return world.isClient & ascension == AetherBlockEntityTypes.DUNGEON_SWITCH ? (world1, pos, state1, blockEntity) -> ((DungeonSwitchBlockEntity) blockEntity).clientTick() : null;
        return null;
    }
